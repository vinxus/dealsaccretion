        ...
        return (
                    ...
                    <div className="privacy_policy">
                        ...
                        <p>
                            ...
                            Deals Accretion recognises that your privacy is very important, so it is equally as important to us that <br/>
                            you are confident with the way we handle your personal information.  We fully comply with the General Data Protection <br/>
                            Regulations and the Privacy of Electronic Communications Regulations. This Privacy Policy outlines the way in which we <br/>
                            use and disclose personal data that is provided to us.
                        ...
                        <h6>Description of why Deals Accretion processes personal data (‘processing purpose’)</h6>
                        <h6>Legal basis for the processing purpose</h6>
                        <div>
                            <h6>To process and respond to grant applications</h6>
                            <ul>
                                <li>·       Consent</li>
                                <li>·       Performance of a contract</li>
                            </ul>
                            <h6>To review and analyse our services and begin measuring our impact</h6>
                            <ul>
                                <li>·       Consent</li>
                                <li>·       Performance of a contract</li>
                            </ul>
                        ...
                        <p>
                            Your data is treated as strictly confidential and is only disclosed to parties who have a need to access it, to fulfill the company’s <br/>
                            objectives.  Some of the personal information you may tell us falls under what is deemed sensitive information, for example, your ethnic <b/> 
                            ...
                            or services to grant recipients.<b/> 

                            We may also need to disclose your information if required to do so by law. For example, we are legally required to provide your data to <b/> 
                            HMRC if you have agreed to us claiming Gift Aid on your behalf. We may also share your information with other third parties without consent <b/> 
                            if we are legally required to do so, for example, by a law enforcement agency legitimately exercising a power or if compelled by an order of <b/> 
                            the Court.
                        </p>
                        ...
                        <p>
                            To prevent unauthorised access, maintain data accuracy, and ensure the correct use of information, we have put in place appropriate physical,<b/> 
                            electronic, and managerial procedures to safeguard and secure the information we collect.<b/> <b/> 

                            Individuals have the right to request access to and rectification or deletion of their personal data or restrict processing. You can request <b/> 
                            for us to delete your personal data by filling out this form. You can request for us to send you a copy of all your personal data on our <b/> 
                            records by filling out this form.<b/> <b/> 

                            The Company will comply with all legal obligations including GDPR when we hold your data.  If you have any reason why we should amend, <b/> 
                            delete or restrict use of your data, please contact us to discuss your concern.
                        </p>
                        <h6>What we do if you choose to tell us about your experience of our grant service</h6>
                        <p> 
                            Where we award grants to individuals, we will sometimes ask whether they are happy for us to share their story to help us raise awareness <b/> 
                            of our mission. For example, to write case studies which can be used in our communications including PR and media activity, digital and <b/> 
                            social media, campaigning, fundraising materials and internal communications. We would never use an individual’s story without obtaining <b/> 
                            their consent first. We would always contact the individual to discuss the use of their story in further detail each time. The individual <b/> 
                            can withdraw their consent at any time before publication.

                        </p>
                        <h6>Disclaimer</h6>
                        <p>
                            The content in our Information and Advice sections are provided by third parties such as NHS Choices and the Money Advice Service. It is <b/> 
                            not intended nor should it be construed as providing professional medical, financial or legal advice. The pages and the information contained <b/> 
                            on the pages are not a replacement for obtaining professional medical care or professional legal and financial advice.
                        </p>

                        <h6>Contact us</h6>
                        <ul>
                            <li>If you have any questions or comments about our privacy practices or this Privacy Statement</li>
                            <li>If you want to make use of any of the above rights, or other rights that you may have in relation to your personal data</li>
                            <li>If you wish to view our full Data Protection Policy</li>
                            <li>If you have other questions or requests</li>
                        </ul>

                        <p>
                            Please contact us at info@dealsaccretion.com.  
                        </p>
